...
public class DoLogin extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(serverip==null){serverip="127.0.0.1";Toasteroid.show(this, "Server ip to 127.0.0.1", Toasteroid.STYLES.WARNING, Toasteroid.LENGTH_SHORT);}
		if(serverport==null){serverport="9587";Toasteroid.show(this, "Server port to 9587", Toasteroid.STYLES.WARNING, Toasteroid.LENGTH_SHORT);}
