...
public class DoLogin extends Activity {
    ...
    private static final String DEAFULT_IP = "127.0.0.1";
    private static final String DEAFULT_PORT = "9587";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (serverip == null && serverport == null) {
            serverDetails.edit().putString("serverip", DEAFULT_IP).commit();
            serverDetails.edit().putString("serverport", DEAFULT_PORT).commit();
            Toasteroid.show(this, "DEFAULT HOST -> " + DEAFULT_IP + ":" + DEAFULT_PORT, Toasteroid.STYLES.WARNING, Toasteroid.LENGTH_SHORT);
            serverip = serverDetails.getString("serverip", null);
            serverport = serverDetails.getString("serverport", null);
        }
        if (serverip != null && serverport != null) {
        ...
        protected String doInBackground(String... params) {
            try {
                postData(params[0]);
                     ...
                     BadPaddingException | IOException | JSONException e) {
